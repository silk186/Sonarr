...
class NamingModal extends Component {
  ...
  render() {
    ...
    const seriesTokens = [
      ...
      { token: '{Series Clean Title}', example: 'Series Title 2010' },
      { token: '{Series.Clean.Title}', example: 'Series.Title.2010' },
      { token: '{Series_Clean_Title}', example: 'Series_Title_2010' }
    ];
    ...
    const episodeTitleTokens = [
      ...
      { token: '{Episode Clean Title}', example: 'Episode Title' },
      { token: '{Episode.Clean.Title}', example: 'Episode.Title' },
      { token: '{Episode_Clean_Title}', example: 'Episode_Title' }
    ];
